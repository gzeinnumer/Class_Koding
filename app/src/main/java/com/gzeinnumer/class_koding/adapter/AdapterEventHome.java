...
public class AdapterEventHome extends RecyclerView.Adapter<AdapterEventHome.MyHolder> implements Filterable {
    ...
    public AdapterEventHome(Context context, ArrayList<DataEventItem> list, boolean shimmer) {
