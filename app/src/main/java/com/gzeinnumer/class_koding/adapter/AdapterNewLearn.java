...
public class AdapterNewLearn extends RecyclerView.Adapter<AdapterNewLearn.MyHolder> implements Filterable {
    ...
    public AdapterNewLearn(Context context, ArrayList<DataMateriItem> list, boolean shimmer) {
